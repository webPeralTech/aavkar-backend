...
invoiceItemSchema.statics.getItemStatsByInvoice = function (invoiceId) {
    return this.aggregate([
        { $match: { invoiceId: new mongoose_1.default.Types.ObjectId(invoiceId), isDeleted: false } },
        {
            $group: {
                _id: null,
                totalItems: { $sum: 1 },
...
invoiceItemSchema.statics.getItemsByPriority = function (priority) {
    return this.find({
        priority,
        isDeleted: false,
        steps: { $nin: ['Completed'] }
...
exports.default = mongoose_1.default.model('InvoiceItem', invoiceItemSchema);
