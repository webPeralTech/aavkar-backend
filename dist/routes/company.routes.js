...
router.post('/', upload_1.uploadCompanyLogo, upload_1.handleUploadError, upload_1.processCompanyLogo, upload_1.preprocessCompanyFormData, (0, validation_1.validateRequest)(validation_1.createCompanyWithFileSchema), company_controller_1.createOrUpdate);
/**
 * @swagger
 * /api/companies:
 *   get:
 ...
 */
// get company by id
router.get('/:id', (0, validation_1.validateParams)(validation_1.companyIdParamSchema), company_controller_1.getById);
/**
 * @swagger
 * /api/companies/{id}:
 *   delete:
 ...
 */
// delete company
router.delete('/:id', (0, validation_1.validateParams)(validation_1.companyIdParamSchema), company_controller_1.deleteCompany);
